...
func TestFromGo_Number(t *testing.T) {
	t.Run("float", func(t *testing.T) {
		t.Run("json.Number", func(t *testing.T) {
			v, err := wrap2.FromGo(json.Number("-123.45"))
		...
		t.Run("float32", func(t *testing.T) {
			v, err := wrap2.FromGo(float32(-123.45))
			a, _ := v.NumberGet().Float64()
			assert.Equal(t, err, nil)
			assert.Equal(t, v.Type(), wrap.JsonTypeNumber)
			assert.CloseTo(t, a, -123.45, 1e-9)
		...
		t.Run("float64", func(t *testing.T) {
			v, err := wrap2.FromGo(float64(-123.45))
			a, _ := v.NumberGet().Float64()
			assert.Equal(t, err, nil)
			assert.Equal(t, v.Type(), wrap.JsonTypeNumber)
			assert.CloseTo(t, a, -123.45, 1e-9)
	...
	t.Run("integer", func(t *testing.T) {
		t.Run("json.Number", func(t *testing.T) {
			v, err := wrap2.FromGo(json.Number("123"))
...
func TestFromGo_Object(t *testing.T) {
	t.Run("map[string]any", func(t *testing.T) {
		v, err := wrap2.FromGo(map[string]any{
			"a": nil,
			"b": 123,
			"c": "abc",
			"d": true,
